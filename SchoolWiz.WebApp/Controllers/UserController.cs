...
using SchoolWiz.WebApp.Models.User;
...
namespace SchoolWiz.WebApp.Controllers
{
    ...
    public class UserController : ApplicationBaseController
    {
        ...
        public UserController(UserManager<ApplicationUser> userManager, ILoggerFactory factory)
            : base(userManager)
        {
            _userManager = userManager;
            _logger = factory.CreateLogger("User");
        }
